...
image = face_recognition.load_image_file("harsh3.jpg")
...
for face_landmarks in face_landmarks_list:
    ...
    d.polygon(face_landmarks["top_lip"],fill = (255,0,0,100))
    d.polygon(face_landmarks["bottom_lip"],fill = (255,0,0,100))
